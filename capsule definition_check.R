...
for (tracking_data_file in data_dir_list[1:199]){
  ...
  auto_orient_file <- paste(substring(tracking_data_file,1,15),'.myrmidon',sep='')
  
  ### find tracking system
  ...
  man_orient_file <- paste('manual_ref_',tracking_systems[[rep%%4 + 1 ]],'.myrmidon',sep='')
